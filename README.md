...
Audience: Front-end engineers, mobile developers, and students.  
Primary Capabilities: Dynamic resource retrieval, automated Bearer token checks, and standardized JSON output.  
Stack: PHP, Slim 4 Micro-Framework, MySQL Database, Composer, Apache Web Server, Git Version Control.
